...
//remove characters that might be confusing to read for the websocket client ids.
shortid.characters('123456789abcdefghijkmnpqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ$@!#%&/');
...
server.on('connection', function (ws) {
    ...
    ws.on('close', function () {
        ...
        if (ws.isPlayer) {
            ...
            if (lobby && player.status === Player.status.IN_LOBBY) {
